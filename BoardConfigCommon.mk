...
TARGET_KERNEL_ADDITIONAL_FLAGS := CROSS_COMPILE_COMPAT=arm-linux-gnueabi- AR=llvm-ar NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip
KERNEL_LD := LD=ld.lld
